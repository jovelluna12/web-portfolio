      ...
      <div class="contact-grid">
        <div class="contact-info">
          ...
          <div class="contact-links">
            ...
            <a href="https://github.com/jovelluna12" target="_blank" rel="noreferrer" class="contact-link">
              <span class="link-icon">
...
<style scoped>
.contact-section {
  background: linear-gradient(180deg, rgba(24, 24, 27, 0.5) 0%, var(--background) 100%);
}
